...
namespace personel_takip_sistemi
{
    public partial class Form3 : Form
    {
        ...
        private void Form3_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                pictureBox2.Image = Image.FromFile(Application.StartupPath + "\\personelresimler\\" + Form1.tcno + ".jpg");
            }
            catch
            {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {
                baglantı.Open();
                OleDbCommand selecetsorgu = new OleDbCommand("select * from personeller where tcno='" + maskedTextBox1.Text + "'", baglantı);
                OleDbDataReader kayitokuma = selecetsorgu.ExecuteReader();
